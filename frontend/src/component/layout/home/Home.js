  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background:
            'url(https://img.freepik.com/premium-photo/side-view-laptop-pc-with-color-light-dark-technology-gaming-concept_37129-944.jpg?w=900.webp) center bottom no-repeat',
